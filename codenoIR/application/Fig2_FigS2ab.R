...
# Executes the script that fits all the univariate joint models with the linear modeling (writes in subfolder "intermediate_results/uni_fits/lin")
# Warning: time consuming (several days)... to be run on a computing cluster
source("fit.R")  

# Executes the script that fits the univariate joint models with the nonlinear modeling (writes in subfolder "intermediate_results/uni_fits/nonlin")
# Warning: time consuming (several days)... to be run on a computing cluster
source("fit_nl.R") 
