...
By default, these scripts compute all needed intermediate results from scratch. Another version of the code, in which intermediate results are provided, is available at
